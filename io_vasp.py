"""VASP POSCAR / MCIF structure I/O and band-plot config writing.

Extracted from alterseek_path.py (restructuring phase 4). pymatgen/ase
imports are function-local (kept lazy).
"""
import os
import numpy as np
